...
-- Exports: customer, postal_address, privacy_settings, customer_email, customer_phone_number tables
-- Description: Creates normalized tables for CustomerProfile domain.
